...
class ProcessOutput extends Model
{
    ...
    protected $table = 'process_outputs';

    protected $fillable = [
        'uuid', 'team_id', 'user_id', 'process_id', 'label', 'description',
        'output_type', 'entity_type_id', 'entity_id', 'target_process_id',
        'interlink_id', 'metadata',
    ];
    ...
    public function targetProcess(): BelongsTo { return $this->belongsTo(Process::class, 'target_process_id'); }
